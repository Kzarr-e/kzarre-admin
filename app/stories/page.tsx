      ...
      <div className="min-h-screen">
        ...
        <div className="flex justify-between mb-6">
          ...
          <button
            ...
            className="px-4 py-2 text-[var(--textPrimary)]font-medium rounded-lg hover:opacity-90 flex items-center gap-2"
        ...
        {/* LIST */}
        <div className="overflow-x-auto rounded-xl shadow-sm border bg-[var(--background-card)] dark:bg-[var(--bgCard)]">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b text-left bg-[var(--background-card)] dark:bg-[var(--bgCard)]">
                <th className="px-4 py-3 font-bold text-[var(--textPrimary)] ">Title</th>
                <th className="px-4 py-3 font-bold text-[var(--textPrimary)]">Created</th>
                <th className="px-4 py-3 font-bold text-[var(--textPrimary)]">Status</th>
                <th className="px-4 py-3 font-bold text-[var(--textPrimary)]">
                  Actions
                </th>
              </tr>
            </thead>
              ...
              {stories.map((s) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${s.published
                  ...
                  <td className="px-4 py-3">
                    <div className="inline-flex items-center gap-2">
                      <button
                        ...
                        className="p-2 rounded-lg text-gray-600 hover:bg-[var(--accent-green)] text-green-600 transition"
                        title="Preview"
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg hover:bg-red-400 text-red-600"
                        title="Delete"
                      >
                        <Trash2 size={16} />
                      </button>
        ...
        {previewStory && (
          <div
            className="fixed inset-0 z-50 p-12 flex items-center justify-center bg-black/40 backdrop-blur-sm overflow-y-auto p-4"
            onClick={() => setPreviewStory(null)}
          >
            <div
              className="w-full max-w-4xl max-h-[90vh]  overflow-y-auto bg-[var(--background-card)] dark:bg-[var(--bgCard)]rounded-xl shadow-2xl relative"
            ...
            >
              ...
              <div className="flex justify-between items-center px-6 py-4 border-b">
                ...
                <button
                  onClick={() => setPreviewStory(null)}
                  className="p-2 border rounded-lg hover:border-color"
                >
                  <X size={20} />
                </button>
              </div>
        ...
        {showForm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center  backdrop-blur-sm">
            <div className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-[var(--background-card)] dark:bg-[var(--bgCard)]rounded-xl shadow-2xl relative">
              ...
              {/* BODY */}
              <div className="p-6">
                <div className="border p-6 rounded-lg bg-[var(--background-card)] dark:bg-[var(--bgCard)]">
                  <input
                    className="w-full mb-2 p-2 border rounded bg-[var(--background-card)] dark:bg-[var(--bgCard)]"
                    placeholder="Title"
                    value={title}
                  ...
                  <input
                    className="w-full mb-4 p-2 border rounded bg-[var(--background-card)] dark:bg-[var(--bgCard)]"
                  ...
                  <div className="mb-4">
                    ...
                    {!coverImage ? (
                      <input
                        type="file"
                        className=" mb-4 p-2 border rounded bg-[var(--background-card)] dark:bg-[var(--bgCard)]"
                        accept="image/*"
                        onChange={(e) =>
                          e.target.files &&
                          setCoverImage({
                  ...
                  <div className="flex justify-end gap-3 mt-4">
                    <button onClick={resetForm} className="border text-[var(--textPrimary)] px-4 py-2 rounded">Cancel</button>
                    <button
                      onClick={submit}
                      className="bg-[#A0EDA8] text-black px-4 py-2 rounded"
                    >
